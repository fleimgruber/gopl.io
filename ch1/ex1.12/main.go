...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "web" {
		...
		handler := func(w http.ResponseWriter, r *http.Request) {
			...
			// }
			// cycles, _ := strconv.Atoi(values["cycles"])
			cycles, _ = getcyclesstr(w, r)
			lissajous(w, cycles)
		}
...
func getcyclesstr(w http.ResponseWriter, r *http.Request) (int, error) {
	...
	err := errors.New("Cycles parameter may not be empty")
